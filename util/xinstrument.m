...
if isempty(obs)
	obs = { ...
		...
		'T', 'T', @(a,r) xint(r.kx.^2.*abs(a).^2, r.dk, r), [false true], 1, 'kinetic energy'; ...
		'K', 'K', @(a,r) xint(r.a.K(r).*abs(a).^2, r.dx, r), [], 1, 'external potential energy'; ...
		'R', 'R', @(a,r) xint(r.a.g.*abs(a).^4, r.dx, r), [], 1, 'repulsion energy'; ...
